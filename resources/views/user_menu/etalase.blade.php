<x-app-layout>
  ...
  <div class="py-12">
      <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
          <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4" >
            @foreach ($data as $item)
              <div class="flex p-6 text-gray-900 dark:text-gray-100">
                <div class="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                    <a href="#">
                        <img class="p-8 rounded-t-lg" src="blyat" alt="product image" />
                    </a>
                        <div class="px-5 pb-5">
                            <a href="#">
                            ...
                            <div class="flex items-center mt-2.5 mb-5">
                                ...
                                <span class="text-3xl font-bold text-gray-900 dark:text-white">{{$item['stok']}}</span>
                                </div>
                            </div>
